                            ...
                            <div id="collapse2" class="body">
                                ...
                                <form class="form-horizontal" id="popup-validation"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <select class="validate[required] form-control" name="service_type_id">
                                                <option value="">Select service</option>
                                                @foreach($service_types as $service)
                                                    <option value="{{ $service->id }}" @if(old('service_type_id', $category->service_type_id) == $service->id) selected @endif>{{ $service->label }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" class="validate[required] form-control" name="name"
                                                   id="req" value="{{ old('name', $category->getRawOriginal('name')) }}" placeholder="Category name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" class="validate[required] form-control" name="code"
                                                   id="req" value="{{ old('code', $category->code) }}" placeholder="Short name of category">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-4">
                                            <select class="validate[required] form-control" name="color" required>
                                                ...
                                                @foreach($colors as $k => $color)
                                                    <option value="{{ $color }}" @if(old('color', $category->color) == $color) selected @endif>{{ $color }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
