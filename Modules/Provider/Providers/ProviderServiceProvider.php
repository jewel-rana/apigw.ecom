...
use Modules\Provider\Repositories\ProviderDepositRepository;
use Modules\Provider\Repositories\ProviderRepository;
use Modules\Provider\Repositories\ProviderUserRepository;
...
class ProviderServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(ProviderDepositRepositoryInterface::class, ProviderDepositRepository::class);
        $this->app->bind(ProviderUserRepositoryInterface::class, ProviderUserRepository::class);
    }
