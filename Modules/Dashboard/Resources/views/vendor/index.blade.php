@extends('goodlayout::.layouts.master')
                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="mb-2">
                            ...
                            <h1 class="fw-semibold text-gray-800 text-center lh-lg">Quick form to
                                <br />
                                <span class="fw-bolder">Add New Shipment</span></h1>
                            <!--end::Title-->
                            <!--begin::Illustration-->
                        ...
                        <div class="text-center mb-1">
                            ...
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a class="btn btn-sm btn-light" href="../dist/apps/invoices/view/invoice-2.html">Quick Guide</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Links-->
                    </div>
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card card-flush h-lg-100">
                            ...
                            <div class="card-header py-7 mb-3">
                                ...
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    <a href="../dist/apps/ecommerce/sales/listing.html" class="btn btn-sm btn-light">View All</a>
                                </div>
                                <!--end::Toolbar-->
                            </div>
                            <!--end::Header-->
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="text-center pt-9">
                            <a href="../dist/apps/ecommerce/catalog/add-product.html" class="btn btn-primary">Add Vehicle</a>
                        </div>
                    </div>
                    <!--end::Body-->
                </div>
