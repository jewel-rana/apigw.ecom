                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            ...
                            <div id="collapse2" class="body">
                                <form class="form-horizontal" id="popup-validation" action="{{ route('gateway.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" value="{{ old('class_name') }}" class="validate[required] form-control" name="class_name"
