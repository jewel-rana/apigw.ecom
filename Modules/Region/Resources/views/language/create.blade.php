                                    ...
                                    <form action="{{ route('language.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label class="radio-inline">
                                                <input type="radio" name="type" value="ltr" @if(old('type', 'ltr') == 'ltr') checked @endif> LTR (Left align)
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="type" value="rtl" @if(old('type') == 'rtl') checked @endif> RTL (Right align)
                                            </label>
                                        </div>
