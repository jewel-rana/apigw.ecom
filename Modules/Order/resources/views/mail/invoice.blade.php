                ...
                >
                  ...
                  "
                    >
                        ...
                        <!--[if (mso)|(IE)]><td align="center" width="500" style="background-color: #ffffff;width: 500px;padding: 30px 30px 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
                        <div
                                      ...
                                      "
                                                        ...
                                                        >
                                                            <img
                                                                align="left"
                                                                border="0"
                                                                src="https://dev-admin.kartat.io/storage/uploads/files/2024/05/1716979416.png"
                                                                alt=""
                                                                title=""
                                                                style="
                                          outline: none;
                      ...
                      "
                        ...
                        "
                                >
                                    ...
                                    <div style="text-align: center; font-size: 20px; padding: 40px 0">
                                        <p>INVOICE</p>
                                    </div>
                                ...
                                "
                                                align="left"
                                            >
                                                Date: {{ now()->createFromFormat('d/m/Y h:i a', $order->created_at)->format('d/m/Y') }}
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                ...
                >
                  ...
                  "
                    >
                        ...
                        <!--[if (mso)|(IE)]><td align="center" width="500" style="background-color: #ffffff;width: 500px;padding: 0px 30px 10px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                        <div
                            class="u-col u-col-100"
                            style="
                      max-width: 320px;
                      ...
                      "
                        ...
                        "
                                >
                                    ...
                                    <table
                                        style="font-family: arial, helvetica, sans-serif; border: 1px solid #f7f7f7"
                                        role="presentation"
                                        cellpadding="0"
                                        cellspacing="0"
                                        width="100%"
                                ...
                                "
                                            ...
                                            >
                                                <!--[if mso]><table width="100%">
                                                    <tr>
                                                        <td><![endif]-->
                                                <strong>{{ $order->total_payable }}</strong>
                                                <!--[if mso]></td>
                                                </tr>
                                                </table><![endif]-->
                                            </td>
                ...
                >
                  ...
                  "
                    >
                        ...
                        <!--[if (mso)|(IE)]><td align="center" width="500" style="background-color: #ffffff;width: 500px;padding: 0px 30px 30px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                        <div
                            class="u-col u-col-100"
                            style="
                      max-width: 320px;
                        ...
                        "
                                ...
                                "
                                  ...
                                  "
                                    ...
                                    <span
                                        data-metadata="<!--(figmeta)eyJmaWxlS2V5IjoiMFRxR1FMUTdmU2tMVm9kME1vSFRBRyIsInBhc3RlSUQiOjE1MDIwNjA2NSwiZGF0YVR5cGUiOiJzY2VuZSJ9Cg==(/figmeta)-->"
                                        style="line-height: 19.6px"
                                    ></span
                                    ></span
                                                        >Thank you for choosing Kartat. We look
                ...
                >
                  ...
                  "
                    >
                        ...
                        <!--[if (mso)|(IE)]><td align="center" width="500" style="background-color: #ffffff;width: 500px;padding: 0px 30px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                        <div
                            class="u-col u-col-100"
                            style="
                      max-width: 320px;
                        ...
                        "
                                ...
                                "
                                  ...
                                  "
                                    ...
                                    <span
                                        style="line-height: 19.6px"
                                        data-metadata="<!--(figmeta)eyJmaWxlS2V5IjoiMFRxR1FMUTdmU2tMVm9kME1vSFRBRyIsInBhc3RlSUQiOjE1MTYwMTc0NjEsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)-->"
                                    ></span>
                                                        <span style="line-height: 19.6px"></span>
                        ...
                        "
                                ...
                                "
                                  ...
                                  "
                                    ...
                                    <span
                                        style="line-height: 19.6px"
                                        data-metadata="<!--(figmeta)eyJmaWxlS2V5IjoiMFRxR1FMUTdmU2tMVm9kME1vSFRBRyIsInBhc3RlSUQiOjEyNjI5NTM5NDYsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)-->"
                                    ></span
                                    ><span
                                                            style="line-height: 19.6px"
                                                        ></span
                                                        >© 2024 Kartat. All rights reserved.
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                  ...
                                  "
                                                >
                                                    ...
                                                    <p style="line-height: 140%">
                                                        ...
                                                        registered to join the Kartat platform as a
                                                        user or a creator. This also shows that you
                                                        agree to our Terms of use and Privacy
                                                        Policies. If you no longer want to receive
                                                        mails from use, click the unsubscribe link
                ...
                ">
                  ...
                  "
                    >
                        ...
                        <!--[if (mso)|(IE)]><td align="center" width="500" style="background-color: #ffffff;width: 500px;padding: 0px 30px 40px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                        <div
                            class="u-col u-col-100"
                            style="
                      max-width: 320px;
                        ...
                        ">
                                ...
                                "align="left">
                                  ...
                                  ">
                                                    <p style="line-height: 140%">
                                    <span
                                        data-metadata="<!--(figmeta)eyJmaWxlS2V5IjoiMFRxR1FMUTdmU2tMVm9kME1vSFRBRyIsInBhc3RlSUQiOjIwNzI5NTY3ODYsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)-->"
                                        style="line-height: 19.6px"
                                    ></span>
                                                        <span style="line-height: 19.6px"></span
                                                        ><a
                                                            href="https://dev.kartat.io/pg/privacy-policy"
                                                            target="_blank"
                                                            style="
                                        text-decoration: underline;
                                        line-height: 19.6px;
                                      ...
                                      ">Privacy policy</a>&nbsp;
                                                        <a
                                                            href="https://dev.kartat.io/pg/terms-of-service"
                                                            target="_blank"
                                                            style="
                                        text-decoration: underline;
                                        line-height: 19.6px;
                                      ...
                                      ">Terms of service</a>
                                                        <a
                                                            href="https://dev.kartat.io/contact-us"
                                                            target="_blank"
                                                            style="
                                        text-decoration: underline;
                                        line-height: 19.6px;
