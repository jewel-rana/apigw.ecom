                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            <header>
                                ...
                                <h5>{{ $title ?? 'Orders' }}</h5>
                                <div class="toolbar">
{{--                                    <div class="mt mr" id="reportrange" style="padding: 2px; border: 1px dashed #CCC">--}}
...
{{--                                    </div>--}}
                            ...
                            <div id="collapse4" class="body">
                                <table id="dataTable"
                                    ...
                                    <tr>
                                    <tr>
                                        <th class="table-ids">Order ID</th>
                                        <th>Customer</th>
                                        <th>Order Items</th>
                                        <th>Total Amount</th>
                                        <th>Discount</th>
        ...
        $(function () {
            ...
            let table = $('#dataTable').DataTable({
                ...
                ajax: {
                    ...
                    data: function (data) {
                        data.service_type_id = $('#filterPanel #serviceTypeId').val();
            ...
            $('#orderExport').click(function() {
                ...
                window.location.href = '{{ route('order.export') }}' + "?" + queryString;
            })
        });
